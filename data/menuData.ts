...
export const menuData: MenuCategory[] = [
    ...
    },
    {
        ...
        items: [
            { name: "İnferno", price: 375 },
            { name: "Love 66", price: 375 },
            { name: "Lady Killer", price: 375 },
            { name: "Del Pierro", price: 375 },
            { name: "İzmir Romantik", price: 375 },
            { name: "Absalito Zero", price: 375 },
            { name: "İsabız Nane", price: 375 },
            { name: "Tatlı Cadı", price: 375 },
            { name: "Dejavu", price: 375 },         // DÜZELTME
            { name: "Enjoy", price: 375 },
            { name: "Turkiş Mastik", price: 375 },  // DÜZELTME
            { name: "Pişmiş Şeftali", price: 375 },
            { name: "Limon", price: 375 },
            { name: "Nane", price: 375 },
            { name: "Anason (Alfakhir)", price: 375 },
            { name: "Nakla", price: 375 },
            { name: "Cappicino", price: 375 },
            { name: "Matmazel", price: 375 },
            { name: "Dark Limon", price: 375 },
            { name: "Coffeein Enerjisi", price: 375 },
            { name: "Zamazinngo", price: 375 },
            { name: "Coffeein Mix", price: 375 },
            { name: "Twist", price: 375 },
            { name: "İce Cola", price: 375 },
            { name: "Red Dream", price: 375 },
            { name: "Pastalya", price: 375 },
            { name: "Klopatra", price: 375 },
            { name: "Egzotica", price: 375 },
            { name: "Laydi Finger", price: 375 },
            { name: "Fantastik", price: 375 },
            { name: "Tropical", price: 375 },
            { name: "Tarçın Sakız", price: 375 },
            { name: "Dominik", price: 375 },
            { name: "Momento", price: 375 },
            { name: "İnfinity", price: 375 },
            { name: "Sweps", price: 375 },          // DÜZELTME
            { name: "Karpuz Nane", price: 375 },
            { name: "Portakal Nane", price: 375 },
            { name: "Üzüm", price: 375 },
            { name: "Elma", price: 375 },
        ],
    },
    {
        ...
        items: [
            ...
            { name: "Nargile + Meyve Suyu", price: 200 },
            { name: "Nargile + Pasta + Çay", price: 210 },
            { name: "Nargile + Pasta + T. Kahvesi", price: 230 },
            { name: "Nargile + Nargile", price: 190 },
            { name: "Nargile + M. Tabağı + Kuruyemiş", price: 210 },
        ],
    },
];